...
## Switches
set_property PACKAGE_PIN V17 [get_ports {digit0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digit0}]
set_property PACKAGE_PIN V16 [get_ports {digit1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digit1}]
set_property PACKAGE_PIN W16 [get_ports {digit2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digit2}]
set_property PACKAGE_PIN W17 [get_ports {digit3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digit3}]
set_property PACKAGE_PIN W15 [get_ports {restart}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {restart}]
#set_property PACKAGE_PIN V15 [get_ports {switch[0]}]					
...
set_property PACKAGE_PIN R3 [get_ports {bits0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bits0}]
set_property PACKAGE_PIN W2 [get_ports {bits1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {bits1}]
set_property PACKAGE_PIN U1 [get_ports {load}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {load}]
set_property PACKAGE_PIN T1 [get_ports {assignvalue0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {assignvalue0}]
set_property PACKAGE_PIN R2 [get_ports {assignvalue1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {assignvalue1}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports buttonload]						
